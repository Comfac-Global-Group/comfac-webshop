...
def execute():
	...
	frappe.reload_doc("webstore", "doctype", "website_item")
	frappe.reload_doc("webstore", "doctype", "website_item_tabbed_section")
	frappe.reload_doc("webstore", "doctype", "website_offer")
	frappe.reload_doc("webstore", "doctype", "recommended_items")
	frappe.reload_doc("webstore", "doctype", "webshop_settings")
