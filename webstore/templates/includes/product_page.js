...
frappe.ready(function() {
	...
	frappe.call({
		type: "POST",
		method: "webstore.webstore.shopping_cart.product_info.get_product_info_for_website",
		args: {
	...
	$("#item-add-to-cart button").on("click", function() {
		frappe.provide('webstore.shopping_cart');

		webstore.shopping_cart.update_cart({
			item_code: get_item_code(),
