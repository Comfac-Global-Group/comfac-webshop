...
$.extend(shopping_cart, {
	...
	apply_shipping_rule: function(rule, btn) {
		return frappe.call({
			btn: btn,
			type: "POST",
			method: "webstore.webstore.shopping_cart.cart.apply_shipping_rule",
	...
	place_order: function(btn) {
		...
		return frappe.call({
			type: "POST",
			method: "webstore.webstore.shopping_cart.cart.place_order",
			btn: btn,
			callback: function(r) {
				if(r.exc) {
	...
	request_quotation: function(btn) {
		...
		return frappe.call({
			type: "POST",
			method: "webstore.webstore.shopping_cart.cart.request_for_quotation",
			btn: btn,
			callback: function(r) {
				if(r.exc) {
					shopping_cart.unfreeze();
	...
	apply_coupon_code: function(btn) {
		return frappe.call({
			type: "POST",
			method: "webstore.webstore.shopping_cart.cart.apply_coupon_code",
			btn: btn,
			args : {
	...
	remove_coupon_code: function(btn) {
		return frappe.call({
			type: "POST",
			method: "webstore.webstore.shopping_cart.cart.remove_coupon_code",
			btn: btn,
			callback: function(r) {
				if (r && r.message){
					location.reload();
