...
from webstore.webstore.doctype.webshop_settings.webshop_settings import show_attachments
...
def get_context(context):
	...
	context.enabled_checkout = frappe.get_doc("Webstore Settings").enable_checkout
