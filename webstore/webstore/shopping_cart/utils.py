...
from webstore.webstore.doctype.webshop_settings.webshop_settings import is_cart_enabled
...
def set_cart_count(login_manager):
	...
	if show_cart_count():
		from webstore.webstore.shopping_cart.cart import set_cart_count
