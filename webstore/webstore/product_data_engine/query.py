...
from webstore.webstore.doctype.item_review.item_review import get_customer
from webstore.webstore.shopping_cart.product_info import get_product_info_for_website
from webstore.webstore.utils.product import get_non_stock_item_status
...
class ProductQuery:
	...
	Attributes:
	        ...
	        settings (Document): Webstore Settings DocType
	"""
	...
	def build_item_group_filters(self, item_group):
		...
		from webstore.webstore.doctype.override_doctype.item_group import get_child_groups_for_website
	...
	def get_stock_availability(self, item):
		...
		from webstore.templates.pages.wishlist import (
