...
from webstore.webstore.doctype.item_review.item_review import get_item_reviews
from webstore.webstore.redisearch_utils import (
    delete_item_from_index,
    insert_item_to_index,
    update_index_for_item,
)
from webstore.webstore.shopping_cart.cart import _set_price_list
from webstore.webstore.doctype.override_doctype.item_group import (
    get_parent_item_groups,
    invalidate_cache_for,
)
from erpnext.stock.doctype.item.item import Item
from erpnext.utilities.product import get_price
from webstore.webstore.shopping_cart.cart import get_party
from webstore.webstore.variant_selector.item_variants_cache import (
...
class WebsiteItem(WebsiteGenerator):
	...
	def set_shopping_cart_data(self, context):
		from webstore.webstore.shopping_cart.product_info import (
...
def has_website_permission_for_website_item(doc, ptype, user, verbose=False):
	...
	if not frappe.db.get_single_value("Webstore Settings", "login_required_to_view_products"):
		return True
