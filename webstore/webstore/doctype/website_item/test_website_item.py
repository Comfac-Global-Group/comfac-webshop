...
from webstore.webstore.doctype.webshop_settings.webshop_settings import (
	get_shopping_cart_settings,
)
from webstore.webstore.doctype.webshop_settings.test_webshop_settings import (
	setup_webshop_settings,
)
from webstore.webstore.doctype.website_item.website_item import make_website_item
from webstore.webstore.shopping_cart.product_info import get_product_info_for_website
from webstore.webstore.doctype.override_doctype.item import DataValidationError
from erpnext.stock.doctype.item.test_item import make_item
from webstore.webstore.doctype.override_doctype.item_group import get_parent_item_groups
...
class TestWebsiteItem(unittest.TestCase):
	...
	def test_index_creation(self):
		...
		from webstore.webstore.doctype.website_item.website_item import on_doctype_update
